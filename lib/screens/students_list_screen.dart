...
import 'package:grocerry/db/database_helper.dart';
import 'package:grocerry/models/student.dart';
import 'package:grocerry/screens/update_student_screen.dart';
                              ...
                              Expanded(
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text('Record No. ${(index+1).toString().padLeft(2, '0')}'),
                                      // Text("Stud ID.       ${s.id.toString()}"),

                                      Text("Name.         ${s.name}"),
                                      Text("Course.       ${s.course}"),
                                      Text("Mobile.        ${s.mobile}"),
                                      Text("Total Fee.    ${s.totalFee}"),
                                      Text("Fee Paid.     ${s.feePaid}"),
                                      Text("Remaining.  ${s.totalFee - s.feePaid}"),
                                    ],
                                  ),
                                ),
                              ),
